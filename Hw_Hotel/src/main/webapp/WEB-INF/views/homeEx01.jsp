...
<head>
<meta charset="utf-8">
<meta name="naver-site-verification" content="0f0b62b00a1ecfa266557bb4895c80415611c721"/>
...
<div id="top_wrap">
	...
	<!-- 탑메뉴 -->
		...
		<ul id="gnb" class="gnb">
			...
			<li class="menu menu_02">
				<a href="../hotel/introduction.php" class="link">NAMOO HOTEL</a>
				<div class="sub_menu sub_bg2">
					<div>
						<a href="../hotel/introduction.php">INTRODUCTION</a>
						<a href="../hotel/concept.php">CONCEPT</a>
						<a href="../hotel/service.php">SERVICES</a>
						<a href="../hotel/local_guide.php">LOCAL GUIDE</a>
						<a href="../hotel/gallery.php">GALLERY</a>
						<a href="../hotel/location.php">LOCATION</a>
					</div>
				</div>
			</li>
			<li class="menu menu_03">
				<a href="../rooms/standard1.php" class="link">ROOMS</a>
				<div class="sub_menu sub_bg3">
					<div>
						<a href="../rooms/standard1.php">STANDARD DOUBLE</a> 
						<a href="../rooms/premium1.php">STANDARD TWIN</a> 
						<a href="../rooms/suite1.php">KOREAN</a> 
					</div>
				</div>
			</li>

			<li class="menu menu_06">
				<a href="../facilities/facilities1.php" class="link">FACILITIES</a>
				<div class="sub_menu sub_bg6">
					<div>
						<a href="../facilities/facilities1.php">RESTAURANT</a> 
						<a href="../facilities/facilities2.php">SEMINAR ROOM</a> 
					</div>
				</div>
			</li>

			<li class="menu menu_05">
				<a href="../community/news.php" class="link">NEWS</a>
				<div class="sub_menu sub_bg5">
					<div>
						<a href="../community/news.php">NEWS</a> 
						<a href="../community/event.php">EVENTS</a>
						<a href="../community/promotion.php">PROMOTION</a>
						<a href="../community/gallery.php">GALLERY</a>
						<a href="../community/contact.php">CONTACT</a>
					</div>
				</div>
			</li>
			
			<li class="menu menu_04">
				<a href="../reservation/reservation.php" class="link">RESERVATION</a>
	...
	<link rel="stylesheet" href="/hotel/resources/css/slider.css" type="text/css" media="screen" />
...
<div id="contents_wrap" class="main_contets">
	...
	<div class="intro_info">
		<ul>
			<li class="m_sb m_sb_1" onclick="location.href='hotel/introduction.php'">
				<div class="img_n_3 img_in1"><img src="/hotel/resources/imges/main_s1.jpg">	</div>
				<dl>
					<dt>INTRODUCTION</dt>
					<dd>나무 호텔은 고객의 눈을 즐겁게 만드는 다양한 디자인적 요소와<br>라이프스타일을 반영한 서비스를 통해 고객에게 한 걸음 더 다가갑니다.</dd>
				</dl>
			</li>
			<li class="m_sb m_sb_2" onclick="location.href='rooms/standard1.php'">
				<div class="img_n_3 img_in2"><img src="/hotel/resources/imges/main_s2.jpg"></div>
				<dl>
					<dt>ROOMS</dt>
					<dd>모던하고 우아한 스타일로 설계된 나무 호텔의 차별성을 가진<br>각각의 객실들은 고객들에게 보다 다양한 선택적 경험을 제공합니다.</dd>
				</dl>
			</li>
			<li class="m_sb m_sb_3" onclick="location.href='facilities/facilities1.php'">
				<div class="img_n_3 img_in3"><img src="/hotel/resources/imges/main_s3.jpg"></div>
				<dl>
					<dt>FACILITIES</dt>
					<dd>나무 호텔은 고객의 여러 욕구를 충족할 수 있는 세련되고<br>정갈한 분위기의 부대 시설을 통한 특별한 서비스를 제공합니다.</dd>
				</dl>
			</li>
		</ul>
	</div>
			...
			<div class="btn_slide btn_next">→</div>		
				<div class="slider">
					<ul>
						...
						<p class="s_img_list"><img src="img/n_main/rooms_1.jpg" alt=""></p>
						<div class="red_b_wrap" onclick="location.href='rooms/standard1.php'">
							<p class="red_bg"></p>
							<div class="red_txt">
								<div class="red_txt_box">
									<p>STANDARD DOUBLE A</p>
									<p><span>\100,000</span><span> / day</span></p>
								</div>
							</div>
						</div>
						...
						<p class="s_img_list"><img src="img/n_main/rooms_2.jpg" alt=""></p>
						<div class="red_b_wrap" onclick="location.href='rooms/standard2.php'">
							<p class="red_bg"></p>
							<div class="red_txt">
								<div class="red_txt_box">
						...
						<p class="s_img_list"><img src="img/n_main/rooms_3.jpg" alt=""></p>
						<div class="red_b_wrap" onclick="location.href='rooms/standard3.php'">
							<p class="red_bg"></p>
							<div class="red_txt">
								<div class="red_txt_box">
						...
						<p class="s_img_list"><img src="img/n_main/rooms_4.jpg" alt=""></p>
						<div class="red_b_wrap" onclick="location.href='rooms/premium1.php'">
							<p class="red_bg"></p>
							<div class="red_txt">
								<div class="red_txt_box">
									<p>STANDARD TWIN A</p>
						...
						<p class="s_img_list"><img src="img/n_main/rooms_5.jpg" alt=""></p>
						<div class="red_b_wrap" onclick="location.href='rooms/premium2.php'">
							<p class="red_bg"></p>
							<div class="red_txt">
								<div class="red_txt_box">
									<p>STANDARD TWIN B</p>
						...
						<li>		
						<p class="s_img_list"><img src="img/n_main/rooms_6.jpg" alt=""></p>
						<div class="red_b_wrap" onclick="location.href='rooms/premium3.php'">
							<p class="red_bg"></p>
							<div class="red_txt">
								<div class="red_txt_box">
									<p>STANDARD TWIN C</p>
						...
						<p class="s_img_list"><img src="img/n_main/rooms_7.jpg" alt=""></p>
						<div class="red_b_wrap" onclick="location.href='rooms/premium4.php'">
							<p class="red_bg"></p>
							<div class="red_txt">
								<div class="red_txt_box">
									<p>STANDARD TWIN D</p>
						...
						<p class="s_img_list"><img src="img/n_main/rooms_8.jpg" alt=""></p>
						<div class="red_b_wrap" onclick="location.href='rooms/suite1.php'">
							<p class="red_bg"></p>
							<div class="red_txt">
								<div class="red_txt_box">
									<p>KOREAN</p>
		...
		<div class="container">
			...
			<div class="reservation_wrap">
				<ul class="reser_top_booking">
					<li style="padding-right:10px;cursor:pointer;">
					<input type="text" id="check_in_id" class="check_in" style="width:176px;color:#fff;font-size:12px;cursor:pointer;" placeholder="Check - In">
					<!-- <a href="#"><img src="../img/inc/dote1.gif" class="check_in_bt"></a></li> -->
					<li style="padding-right:10px;cursor:pointer;">
					<input type="text" id="check_out_id"  class="check_out" style="width:176px;color:#fff;font-size:12px;cursor:pointer;" placeholder="Check - OUT">
					<!-- <a href="#"><img src="../img/inc/dote1.gif" class="check_out_bt"></a></li> -->
					<li class="reser_rooms">
					<select id="b_rooms" class="selectbox" onchange="roomchange_h(this.value);">
					...
					<li style="padding-right:10px;cursor:pointer;">
					<select class="selectbox" id="adult">
					<option value="" selected>Adult</option>
					</select>
					<li style="padding-right:10px;">
					<select class="selectbox" id="child">
					<option selected>Children</option>
					</select><span class="value" id="b_type_txt"></span></li>
					<li class="t_right">
					<button type="button" class="reser_bt" onclick="go_reservation();"></button><!-- <input type="button" class="reser_bt" value=""> --></li>
				</ul>
			</div>
		</div>
	</div>
...
<div id="footer_wrap">
		...
		<ul class="footer_board">
			...
			<li class="f_list">
				...
				<ul class="family_list">
					<li><a href="http://www.namoohotel.com/main.php" target="_blank">베니키아 청주 나무호텔</a></li>
					<li><a href="http://www.namoohotel.co.kr/main.php" target="_blank">충북 혁신도시 나무호텔</a></li>
			...
			<h3>NEWS</h3>
				<ul class="news_list_text">
					<li><a href="/community/news.php?mode=VIEW_FORM&b_no=17"><span>나무호텔 박재출 대표님 충북도 배드민턴 협회 초대...</span><span>2016-08-29</span></a></li>
					<li><a href="/community/news.php?mode=VIEW_FORM&b_no=13"><span>대전 어린이날 행사 안내</span><span>2016-05-05</span></a></li>
					<li><a href="/community/news.php?mode=VIEW_FORM&b_no=12"><span>2016년 5월 대전 공연, 전시 행사 및 축제 안내</span><span>2016-05-05</span></a></li>
					<li><a href="/community/news.php?mode=VIEW_FORM&b_no=1"><span>대전 나무호텔 홈페이지 GRAND OPEN !!</span><span>2015-12-15</span></a></li>
				</ul>
			</li>
		 <ul>
	</div>
	...
	<div class="footer_bg">
		<div class="container">
			<address>본 웹사이트는 게시된 이메일 주소가 전자우편 수집 프로그램이나 그 밖의 기술적 장치를 이용하여 무단 수집되는 것을 거부합니다.</address>
