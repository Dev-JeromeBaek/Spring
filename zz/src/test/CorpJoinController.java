...
//		 String bnPtn1 = "[0-9]{3}";
//		 Pattern pbn1 = Pattern.compile(bnPtn1);
//		 Matcher mbn1 = pbn1.matcher(corp.getC_bn1());
//		 
//		 String bnPtn2 = "[0-9]{2}";
//		 Pattern pbn2 = Pattern.compile(bnPtn2);
//		 Matcher mbn2 = pbn2.matcher(corp.getC_bn2());
//		 
//		 String bnPtn3 = "[0-9]{5}";
//		 Pattern pbn3 = Pattern.compile(bnPtn3);
//		 Matcher mbn3 = pbn3.matcher(corp.getC_bn3());
//		 
//		 if(!mbn1.matches() || !mbn2.matches() || !mbn3.matches()) {
//			 mav.addObject("msg","사업자 등록 번호를 형식에 맞게 입력하세요.");
//			 mav.addObject("center", centerPath + "corpJoin.jsp");
//			 mav.setViewName("home");
//			 return mav;
//		 }
//		 
//		 corp.setC_bn(corp.getC_bn1()+"-"+corp.getC_bn2()+"-"+corp.getC_bn3());
...
//		 String phonePtn1 = "^01(?:0|1[6-9])";
//		 Pattern p1 = Pattern.compile(phonePtn1);
//		 Matcher m1 = p1.matcher(corp.getC_phone1());
...
//		 String telPtn1 = "(0(2|3[1-3]|4[1-4]|5[1-5]|6[1-4]))";
//		 Pattern p11 = Pattern.compile(telPtn1);
//		 Matcher m11 = p11.matcher(corp.getC_tel1());
...
//		if(corp.getC_bn() == null){
//			mav.addObject("msg","blank");
//			mav.addObject("center", centerPath + "corpJoin.jsp");
//			
//			mav.setViewName("home");
//			
...
//		 corp.setC_bn(corp.getC_bn1()+"-"+corp.getC_bn2()+"-"+corp.getC_bn3());
	...
	public ModelAndView corpLogin(Corp corp, HttpSession session){
...
//		corp.setC_bn(corp.getC_bn1()+"-"+corp.getC_bn2()+"-"+corp.getC_bn3());
		...
		if(corpLog != null){
			session.setAttribute("corpLogin",corpLog);
			mav.addObject("msg",corpLog.getC_bn()+"님 환영해요.");
			mav.setViewName("redirect:Home");
//			mav.addObject("center", "/WEB-INF/views/centerIndex.jsp?c_num="+getC_num());
			return mav;
		}else{
...
//		 if(corp.getC_pw().equals(corp.getC_pwCheck())){
//				mav.addObject("msg","비밀번호가 정상적으로 일치합니다.");
//			}else{
//				mav.addObject("msg","비밀번호를 일치 시켜 입력해주세요.");
//			}
