...
<div>
	<article id="ct_cs">
		...
		<form action="/aaa/yeob/modifyQna" method="post" id="fff">
		...
		<div class="btn_section">
			...
			<i class="btn_cancel"><button type="button" id="_cancelWrite" data-redirect="/aaa/yeob/memQnaList">수정 취소하기</button></i>
		</div>
		</form>
	</article>
</div>
