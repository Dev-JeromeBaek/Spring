...
<div>
	<article id="ct_cs">
		...
		<form action="/aaa/yeob/insertQna" method="post" id="fff">
		...
		<div class="btn_section">
			...
			<i class="btn_cancel"><button type="button" id="_cancelWrite" onclick="javascript:location.href='/aaa/yeob/memQnaList'">취소하기</button></i>
		</div>
		</form>
	</article>
</div>
