...
<head>
    ...
    <link rel="shortcut icon" href="/yeob/resources/developer/favicon.ico">  
    <link href='http://fonts.googleapis.com/css?family=Lato:300,400,300italic,400italic' rel='stylesheet' type='text/css'>
    <link href='http://fonts.googleapis.com/css?family=Montserrat:400,700' rel='stylesheet' type='text/css'> 
    <!-- Global CSS -->
    <link rel="stylesheet" href="/yeob/resources/developer/assets/plugins/bootstrap/css/bootstrap.min.css">   
    <!-- Plugins CSS -->
    <link rel="stylesheet" href="/yeob/resources/developer/assets/plugins/font-awesome/css/font-awesome.css">
    
    <!-- github calendar css -->
    <link rel="stylesheet" href="/yeob/resources/developer/assets/plugins/github-calendar/dist/github-calendar.css"
/>
    <!-- github acitivity css -->
    <link rel="stylesheet" href="/yeob/resources/developer/assets/plugins/github-activity/src/github-activity.css">
    <link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/octicons/2.0.2/octicons.min.css">
    
    <!-- Theme CSS -->  
    <link id="theme-style" rel="stylesheet" href="/yeob/resources/developer/assets/css/styles.css">
...
<body>
    ...
    <header class="header">
        <div class="container">                       
            <img class="profile-image img-responsive pull-left"  src="/yeob/resources/developer/assets/images/Yeob.jpg" alt="Seung Yeob BAEK" 
            	style="width: 150px; height: 200px;"/>
            <div class="profile-content pull-left">
                <h1 class="name">Seung Yeob BAEK</h1>
                        ...
                        <div class="content">    
                            ...
                            <div class="item featured text-center">
                                ...
                                <div class="featured-image">
                                    ...
                                    <img class="img-responsive project-image" src="/yeob/resources/developer/assets/images/projects/project-featured.png" alt="project name" />
                                    </a>
                                    <div class="ribbon">
                            ...
                            <div class="item row">
                                ...
                                <img class="img-responsive project-image" src="/yeob/resources/developer/assets/images/projects/project-5.png" alt="project name" />
                                </a>
                            ...
                            <div class="item row">
                                ...
                                <img class="img-responsive project-image" src="/yeob/resources/developer/assets/images/projects/project-4.png" alt="project name" />
                                </a>
                                <div class="desc col-md-8 col-sm-8 col-xs-12">
                            ...
                            <div class="item row">
                                ...
                                <img class="img-responsive project-image" src="/yeob/resources/developer/assets/images/projects/project-1.png" alt="project name" />
                                </a>
                                <div class="desc col-md-8 col-sm-8 col-xs-12">
                            ...
                            <div class="item row">
                                ...
                                <img class="img-responsive project-image" src="/yeob/resources/developer/assets/images/projects/project-2.png" alt="project name" />
                                </a>
                                <div class="desc col-md-8 col-sm-8 col-xs-12">
                    ...
                    <div class="section-inner">
                        ...
                        <div class="content">
                            <ul class="list-unstyled">
                                <li><i class="fa fa-map-marker"></i><span class="sr-only">Location:</span>Seoul.Korea</li>
                                <li><i class="fa fa-envelope-o"></i><span class="sr-only">Email:</span><a href="#">superior051@icloud.com</a></li>
                                <li><i class="fa fa-link"></i><span class="sr-only">Website:</span><a href="https://www.instagram.com/b.seungyeub/">https://www.instagram.com/b.seungyeub/</a></li>
                            </ul>
                        </div><!--//content-->  
                    </div><!--//section-inner-->                 
                </aside><!--//aside-->
    ...
    <!-- Javascript -->          
    <script type="text/javascript" src="/yeob/resources/developer/assets/plugins/jquery-1.11.3.min.js"></script>
    <script type="text/javascript" src="/yeob/resources/developer/assets/plugins/bootstrap/js/bootstrap.min.js"></script>    
    <script type="text/javascript" src="/yeob/resources/developer/assets/plugins/jquery-rss/dist/jquery.rss.min.js"></script> 
    ...
    <script type="text/javascript" src="/yeob/resources/developer/assets/plugins/github-calendar/dist/github-calendar.min.js"></script>
    <!-- github activity plugin -->
    <script type="text/javascript" src="//cdnjs.cloudflare.com/ajax/libs/mustache.js/0.7.2/mustache.min.js"></script>
    <script type="text/javascript" src="/yeob/resources/developer/assets/plugins/github-activity/src/github-activity.js"></script>
    <!-- custom js -->
    <script type="text/javascript" src="/yeob/resources/developer/assets/js/main.js"></script>            
</body>
</html> 
