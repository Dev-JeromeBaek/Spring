...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-35" data-genuitec-path="/aaa/src/main/webapp/WEB-INF/views/corpPage/individual/center/dealInsert.jsp">


	<form name="suinfrm" method="post" action="/aaa/idvCorp/dealSuccess"
		enctype="multipart/form-data" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-35" data-genuitec-path="/aaa/src/main/webapp/WEB-INF/views/corpPage/individual/center/dealInsert.jsp">
