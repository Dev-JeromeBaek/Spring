...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-57" data-genuitec-path="/aaa/src/main/webapp/WEB-INF/views/dealPage/center/digitalList.jsp">
	<br data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-57" data-genuitec-path="/aaa/src/main/webapp/WEB-INF/views/dealPage/center/digitalList.jsp">
	<br>
	<br>
	<span id="rconrners2" style=" font: italic bold 3.0em/1em Georgia, serif;">${kinds}</span>
	<br>
	<br>
	<br>
	<div class="pan01">
		<c:forEach var="i" items="${ digitalList }">
				<div class="sector">
			<figure class="snip1268">
				<div class="image">
					...
					<a href="/aaa/appliance_digital/digitalOne?di_num=${i.di_num}" class="add-to-cart">보러가기</a>
				</div>
				<figcaption >
					<h3 style="text-align: right"> Product_Name &nbsp;  : &nbsp;  ${ i.di_name }</h3>
					<br>
					<h3 style="text-align: right"> Category &nbsp; : &nbsp; ${ i.di_category }</h3>
					<br>
					<div class="price">Price &nbsp; : &nbsp; ${ i.di_price }</div>
				</figcaption>
			</figure>
				</div>
		</c:forEach>
