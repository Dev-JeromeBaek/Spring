...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-118" data-genuitec-path="/aaa/src/main/webapp/WEB-INF/views/memPage/center/qnaModify.jsp">
<div data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-118" data-genuitec-path="/aaa/src/main/webapp/WEB-INF/views/memPage/center/qnaModify.jsp">
	<article id="ct_cs">
		<h2 class="title">1:1 문의글 수정하기</h2>
		<p class="must_txt_info"><span>*</span> 표시정보는 필수 입력 사항입니다.</p>
		<form action="/aaa/mem/modifyQna" method="post" id="fff">
		<table border="1" class="tb_inquiry">
			...
			<tr>
				...
				<td>
					<select title="문의유형 선택" name="category1" id="selCategory1" style="width:176px" value="${qna.q_select }">
			...
			<tr>
				...
				<td><input type="text" name="title" id="inTitle" title="문의제목 입력" style="width:500px" value="${qna.q_title }"></td>
			</tr>
			<tr>
				...
				<td class="relation_qna">
					...
					<input type="hidden" name="num" value="${qna.q_num }">
				</td>
			</tr>
			<tr>
				<th scope="row"><i><span>*</span>문의내용</i></th>
				<td><textarea cols="30" rows="5" name="content" id="inContent" title="문의내용 입력" >${qna.q_content }</textarea></td>
			</tr>
			</tbody>
		</table>
		<div class="btn_section">
			<i class="btn_inquiry"><button type="button" onclick="javascript:insertqq()">문의 수정하기</button></i>
			<i class="btn_cancel"><button type="button" onclick="javascript:location.href='/aaa/mem/memQnaList';">수정 취소하기</button></i>
		</div>
		</form>
	</article>
</div>
