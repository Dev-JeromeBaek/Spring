...
<body style="text-align: center;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-99" data-genuitec-path="/aaa/src/main/webapp/WEB-INF/views/memPage/center/cartPhonePopup.jsp">
<c:choose>
...
function success(totalprice,discountpoint,point,di_nums) {
	location.href=
		"/aaa/mem/cartphonePopupTwo?totalprice="+totalprice+"&discountpoint="+discountpoint+"&point="+point+"&di_nums="+di_nums;
}
