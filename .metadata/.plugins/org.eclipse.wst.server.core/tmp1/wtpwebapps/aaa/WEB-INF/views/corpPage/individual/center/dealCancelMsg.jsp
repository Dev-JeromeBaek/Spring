...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-33" data-genuitec-path="/aaa/src/main/webapp/WEB-INF/views/corpPage/individual/center/dealCancelMsg.jsp">
	<fieldset class="popField" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-33" data-genuitec-path="/aaa/src/main/webapp/WEB-INF/views/corpPage/individual/center/dealCancelMsg.jsp">
		...
		<div style="border: 1px solid yello; width: 185px; float: left; margin-left: 10px;">
			...
			<table style="padding: 5px;">
				...
				<tbody>
					...
					<tr>
						<td class="bodyTitle">&nbsp;Cancel Msg</td>
						<td class="bodyContent">
							<pre class="bodyText">${ di.getDi_exp() }</pre>
						</td>
					</tr>
				</tbody>
				<tfoot>
