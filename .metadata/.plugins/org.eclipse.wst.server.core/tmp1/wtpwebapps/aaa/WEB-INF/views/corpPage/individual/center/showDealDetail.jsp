...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-48" data-genuitec-path="/aaa/src/main/webapp/WEB-INF/views/corpPage/individual/center/showDealDetail.jsp">
	<fieldset class="popField" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-48" data-genuitec-path="/aaa/src/main/webapp/WEB-INF/views/corpPage/individual/center/showDealDetail.jsp">
	<legend class="cancelLegend">[ ${ co.getC_name() } : ${ di.getDi_name() }(${ dd.get(0).getDd_kind() }) 상세 정보 ]</legend>
		...
		<div style="border: 1px solid yello; width: 185px; float: left; margin-left: 10px;">
			<c:forEach var="i" items="${ dd }">
				<p>품목 : ${ i.getDd_name() } / 가격 : ${ i.getDd_price() }</p>
			</c:forEach>
		</div>
