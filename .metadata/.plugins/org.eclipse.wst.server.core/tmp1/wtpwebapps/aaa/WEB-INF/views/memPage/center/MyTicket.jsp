...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-93" data-genuitec-path="/aaa/src/main/webapp/WEB-INF/views/memPage/center/MyTicket.jsp">
<c:choose>
...
<nav id="nav-1">
  ...
  <div class="con">
      <nav class="navecation">
       <ul id="navi">
    <li><a class="menu" href="/aaa/mem/Myshipping">배송상품</a></li>
