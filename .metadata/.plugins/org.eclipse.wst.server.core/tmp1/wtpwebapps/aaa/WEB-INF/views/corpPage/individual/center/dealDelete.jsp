...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-34" data-genuitec-path="/aaa/src/main/webapp/WEB-INF/views/corpPage/individual/center/dealDelete.jsp">
	...
	<c:forEach var="i" items="${myDealList}">
				<figure class="snip1268">
					<div class="image">
						...
						<a onclick="deleteCheck('${i.di_num}')" class="add-to-cart"
							style="cursor: pointer;">삭제하기</a>
					</div>
					<figcaption>
						<h2>${i.di_name}</h2>
						<p>${i.di_exp}</p>
	...
	<script type="text/javascript" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-34" data-genuitec-path="/aaa/src/main/webapp/WEB-INF/views/corpPage/individual/center/dealDelete.jsp">
		function deleteCheck(num) {
			var url = "/aaa/idvCorp/deleteDealCheck?di_num=" + num;
			var popname = num + "딜삭제확인페이지";
			var size = "width=500px, height=300px, left=550px, top=300px";
