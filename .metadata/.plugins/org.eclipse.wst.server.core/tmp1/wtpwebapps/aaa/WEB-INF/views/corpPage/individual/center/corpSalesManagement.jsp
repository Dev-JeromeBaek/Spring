...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-32" data-genuitec-path="/aaa/src/main/webapp/WEB-INF/views/corpPage/individual/center/corpSalesManagement.jsp">
		<meta charset="UTF-8" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-32" data-genuitec-path="/aaa/src/main/webapp/WEB-INF/views/corpPage/individual/center/corpSalesManagement.jsp">
	<title>Insert title here</title>
...
<body>
	...
	<div class="counterBox" style="<%-- border: 1px solid green; --%> width: 1150px; height: 50px; margin-left: 150px;">
		...
		<div class="counter" data-count="${ yearSales }"style=" border: 1px solid orange;"></div>
		<span class="ss">${ yearSales } 원</span>
		<div class="tit3" style=" <%-- border: 1px solid blue; --%>">이번 달 매출 :</div>
		<div class="counter" data-count="${ monthSales }"style=" border: 1px solid orange;"></div>
		<span class="ss">${ monthSales } 원</span>
		<div class="tit3" style=" <%-- border: 1px solid blue; --%>">금일 매출 :</div>
		<div class="counter" data-count="${ daySales }"style=" border: 1px solid orange;"></div>
