...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-20" data-genuitec-path="/aaa/src/main/webapp/WEB-INF/views/adminPage/top/topIndex.jsp">
<div style="background-color: white; opacity: 0.9; width: 1500px; height: 250px; left: 200px; top: 50px; position: relative; z-index: 1" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-20" data-genuitec-path="/aaa/src/main/webapp/WEB-INF/views/adminPage/top/topIndex.jsp">
<div class="topMid">
