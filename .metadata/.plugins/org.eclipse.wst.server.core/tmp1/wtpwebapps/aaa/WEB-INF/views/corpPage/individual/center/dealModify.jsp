...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-36" data-genuitec-path="/aaa/src/main/webapp/WEB-INF/views/corpPage/individual/center/dealModify.jsp">
	<c:choose>
	<c:when test="${ !myDealList.isEmpty() }"> 
	<c:forEach var="i" items="${myDealList}">
		<c:if test="${ i.getDi_approve().equals('YES') }">
			<figure class="snip1268">
				<div class="image">
					<img src="/aaa/resources/files/${i.di_sysName.split(',')[0]}" alt="sq-sample4"/>
						<div class="icons">
						</div>
					<a onclick="modifyAmount('${i.di_num}')" class="add-to-cart"
	...
	<script type="text/javascript" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-36" data-genuitec-path="/aaa/src/main/webapp/WEB-INF/views/corpPage/individual/center/dealModify.jsp">
		function modifyAmount(num) {
			location.href="/aaa/idvCorp/modifyAmount?di_num="+num;
		}
 	</script>
</body>
</body>
