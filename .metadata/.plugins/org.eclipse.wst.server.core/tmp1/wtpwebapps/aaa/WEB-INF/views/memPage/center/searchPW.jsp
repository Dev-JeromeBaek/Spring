...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-123" data-genuitec-path="/aaa/src/main/webapp/WEB-INF/views/memPage/center/searchPW.jsp">
	<c:choose>
			<c:when test="${!m_pw.isEmpty() }">
		  ...
		  <table border="1" style="text-align: center; " align="center;">
		 	 ...
		 	 <tr>
		  		<td>
		    		<label class="subject" for="subject">비밀번호  </label>
		   		</td>
		   		<td>
		    		<label class="subject" for="subject">${ m_pw }</label>
		   		</td>
		 	</tr>
			<tr>
		  		<td colspan="2">
