...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-88" data-genuitec-path="/aaa/src/main/webapp/WEB-INF/views/localPage/detail.jsp">

	<!-- Page Content -->
	<div class="container" style="padding-left: 30px; padding-right: 30px;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-88" data-genuitec-path="/aaa/src/main/webapp/WEB-INF/views/localPage/detail.jsp">
