...
<body style="text-align: center;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-106" data-genuitec-path="/aaa/src/main/webapp/WEB-INF/views/memPage/center/directPhonePopup.jsp">
<c:choose>
