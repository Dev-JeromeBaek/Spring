...
<body style="text-align: center;" class="bodybidy" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-98" data-genuitec-path="/aaa/src/main/webapp/WEB-INF/views/memPage/center/cartCardPopup.jsp">
<c:choose>
