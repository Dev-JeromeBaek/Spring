...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-50" data-genuitec-path="/aaa/src/main/webapp/WEB-INF/views/corpPage/individual/center/showSalesAll.jsp">
		
	<div class="counterBox" style="<%-- border: 1px solid green; --%> width: 800px; height: 50px; margin-left: 300px;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-50" data-genuitec-path="/aaa/src/main/webapp/WEB-INF/views/corpPage/individual/center/showSalesAll.jsp">
